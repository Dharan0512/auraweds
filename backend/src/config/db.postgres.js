...
var postgresUri = process.env.POSTGRES_URI ||
    "postgres://postgres:postgres@localhost:5432/auraweds";
exports.sequelize = new sequelize_1.Sequelize(postgresUri, {
    dialect: "postgres",
    logging: false,
...
var connectPostgres = function () { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 2:
                error_1 = _a.sent();
                console.error("Unable to connect to the PostgreSQL database:", error_1);
                throw error_1;
